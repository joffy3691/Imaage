...
while True:
    ...
    if event == 'Encrypt' and values['key']:
        ...
        im = cv2.imread("/home/pratyush/Downloads/Imaage/Image-Encryption-and-Authentication/" + values['-FILE LIST-'][0])
        filename = '/home/pratyush/Downloads/Imaage/Image-Encryption-and-Authentication/' + values['-FILE LIST-'][0]
