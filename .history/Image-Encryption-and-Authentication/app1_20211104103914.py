...
while True:
    ...
    if event == 'Decrypt' and values['key']:
        ...
        im = cv2.imread(values['-FILE LIST-'][0])
        filename = values['-FILE LIST-'][0]
        print("decrypt filename = ", filename)
        exif_dict = piexif.load('/home/pratyush/Downloads/Imaage/Image-Encryption-and-Authentication/' + filename)
        ...
        param2.decrypt('crop_{1}.jpeg',values['key'], values['Rsakey'], values['Publickey'])
