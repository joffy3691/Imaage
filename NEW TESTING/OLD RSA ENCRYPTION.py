...
def Rsa_testing(image_loc,column,outputloc):
    ...
    df.to_parquet(f'{outputloc}.tiff.parquet.gzip', compression='gzip')
    # plt.imshow(my_img)
    # plt.show()
...
outputloc="RSA-tiff-Enc-4.2.06"
column = []
column.append((0, 0, 0))
column.append((0, 0, 0))
tic = time.perf_counter()
Rsa_testing("C:/Users/vishn/PycharmProjects/imo/dtjdtg/Test_images/tiff/4.2.06.tiff",column,outputloc)
