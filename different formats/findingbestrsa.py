...
def partialencrypt(image, key, column,imagelocation):
    ...
    df.to_parquet(f'{imagelocation}.bmp.parquet.gzip', compression='gzip')
...
for i in range(100000):
    E,D,N=partialencrypt("C:/Users/vishn/PycharmProjects/imo/dtjdtg/Test_images/bmp/4.1.01.bmp","ABCD",column,"propenc_image")
    Dec_image = "C:/Users/vishn/PycharmProjects/imo/dtjdtg/different formats/dec_image.bmp"
    Enc_image = "C:/Users/vishn/PycharmProjects/imo/dtjdtg/different formats/propenc_image.bmp"
    # print("RMSE :" + str(rootmeansquareerror(Dec_image,Enc_image)))
    # print("NPCR :" + str(npcrv(Dec_image, Enc_image)))
    if(npcrv(Dec_image, Enc_image)>99.65 and uaci2(Dec_image, Enc_image)>31.5 ):
        print("E:",E)
        print("D:", D)
        print("N:", N)
