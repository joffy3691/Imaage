...
img = Image.open(r"C:/Users/vishn/PycharmProjects/imo/dtjdtg/FINAL/output.png").convert('RGB')
...
img.save('C:/Users/vishn/PycharmProjects/imo/dtjdtg/FINAL/output.png')
img.show()